...
# Why do you think it happens? I think numeric class may only appear if all the characters in it are numeric classes.
```
...
combined_logical <- c(num_logical, char_logical) #only 1 true as a charater out of the total of eight characters
```

You’ve probably noticed that objects of different types get converted into a single, shared type within a vector. In R, we call converting objects from one class into another class coercion. These conversions happen according to a hierarchy, whereby some types get preferentially coerced into other types. What is the order of the hierarchy? 
The numberical class is always coerced into the character class once both classes appear together. So the character class is above the numerical class.

```{r}
# Build a vector of the study semesters: 
study_sem <- c("winter2015", "fall2015", "winter2016", "fall2016", "winter2017", "fall2017", "winter2018","fall2018", "winter2019", "fall2019")

# Build a vector where the supplements consumed matches the order of the study semesters: 
supplement_sem <- c("RPS", "RMS", "RPS", "Insulin", "Arabinoxylan", "RPS", "RPS", "RMS", "Insulin", "Accessible", "RPS", "HiMaize", "Banana", "HiMaize", "RPS", "RMS", "RPS", "RPS", "Oat", "Rice", "Potato" )
...
mean(7.75,6,7.5,8,7.75)
round(7.75, digits=2)

pH_2 <- c("8", "7.25", "7.25", "7.75", "7.5", "7.25")
mean(8,7.25,7.25,7.75,7.5,7.25)
round(8,digits = 2)
```
