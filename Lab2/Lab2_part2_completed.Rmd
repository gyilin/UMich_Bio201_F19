...
What do you think is the current content of the object height_cm? 182.88 or 167.44? 182.88
...
class(tricky)
# Why do you think it happens? There is likely a hierarchy of data types within the program itself. The hierarchy, based on the above data likely comes out as: character, then numeric, then logical. Since only one will show up if two types are present, the one that is higher-up in the herarchy will show up. 
```
...
print(combined_logical)

# combined_logical has "TRUE" as a character once. 
```
...
study_sem <- c("W2015", "F2015", "W2016", "F2016", "W2017", "F2017", "W2018", "F2018", "W2019", "F2019")

# Build a vector where the supplements consumed matches the order of the study semesters: 

supp_by_sem <- c("RPS", "RMS", "RPS", "Inulin", "Arabinoxylan", "Psyllium", "RPS", "RPS", "RPS", "RMS", "Inulin", "Accessible", "RPS", "HiMaize", "banana", "HiMaize", "RPS", "RMS", "RPS", "RPS")

# What type are each of these? All are characters 
class(supp_by_sem)
class(study_sem)
...
class(college_age) #The output was "numeric". 

# Convert this vector to character:
college_age <- c(18, 19, 20, 21, 22, "c")
```
