...
knitr::opts_knit$set(root.dir = "/Users/tina5/UMich_Bio201_F19/Lab2/")
```
...
#If there is any "character" in a single vector, then other objects is this vector are coerced into "character". The class of this vector is character. 
#For the "num_logical", true represents "1" and false represents "0", so that class of "num_logical" is numeric.
...
study_semesters <- c("Fall2019", "Winter2019", "Spring2019", "Summer2019")
# Build a vector where the supplements consumed matches the order of the study semesters: 
supplments <- c("textbooks", "pencils", "staplers", "filler papers")
