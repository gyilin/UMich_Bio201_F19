...
What am I interested in this class?

## Does the brand of RPS influence the frequency of a butyrogenic response?

~~I have heard R language for a long time!~~

# The first thing I want to learn is how to analyze data by using R.

`Another thing is I am now working in a lab, so that there are lots of data every day.`


> I hope what I learned from this class could help me to deal with those data.
