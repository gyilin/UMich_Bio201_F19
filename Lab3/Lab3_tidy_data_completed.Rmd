...
scfa_wkly_qc <- read_excel("raw_data/SCFA_data.xlsx",
  ...
  mutate(total_SCFA_mM_median = acetate_mM_median + butyrate_mM_median + propionate_mM_median,
         total_SCFA_mM_mean = acetate_mM_mean + butyrate_mM_mean + propionate_mM_mean)
