...
tax_ratio <- inner_join(Fr, Br, 
  ...
  tax_ratio_1 <- inner_join(tax_ratio, scfa_ratio,
                            by= c("participant_id", "study_week")) #join with scfa_ratio data frame
```
...
#the p value is  < 2.2e-16, which means we can use the linear model to interpreate the correlation that there could some linear relationship about butryate concentration and Firmicutes abudance; and the adjusted R-squared value is 0.003863, which is way smaller than 0.8 and means there is no linear relationship found.
```
...
#the p value is  < 2.2e-16, which means we can use the linear model to interpreate the correlation that there is some linear reationship between the propionate concentration and Bacteroidetes abundance; and the adjusted R-squared value is 0.04197, which is way smaller than 0.8 and means there is no linear relationship found 
```
...
#the p value is  < 2.2e-16, which means we can use the linear model to interpreate the correlation that there is some linear reationship between the propionate concentration and Bacteroidetes abundance; and the adjusted R-squared value is 0.02, which is way smaller than 0.8 and means there is no linear relationship found.
```
...
#the p value is  < 2.2e-16, which means we can use the linear model to interpreate the correlation that there is some linear reationship between the propionate concentration and Bacteroidetes abundance; and the adjusted R-squared value is 0.883, bigger than 0.8 , which means the dots strongly fit into the straignt line (the correlation is  monotonic and there is linear relationship).
```
...
#the p value is  0.00025, which means we can use the linear model to interpreate the correlation that there is some linear reationship between the propionate concentration and Bacteroidetes abundance; and the adjusted R-squared value is 0.001316, which is way smaller than 0.8 and means there is no linear relationship found 
```
...
#the p value is  < 2.2e-16, which means we can use the linear model to interpreate the correlation that there is some linear reationship between the propionate concentration and Bacteroidetes abundance; and the adjusted R-squared value is 0.07148, which is way smaller to 0.8 and means there is no linear relationship found 
```
...
#the p value is  < 2.2e-16, which means we can use the linear model to interpreate the correlation that there is some linear reationship between the propionate concentration and Bacteroidetes abundance; and the adjusted R-squared value is 0.05209, which is way smaller than 0.8 and means there is no linear relationship found 
```
