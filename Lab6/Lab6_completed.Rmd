...
```{r}
# taxanomic data
taxa_category <- read_delim("C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/raw_data/person_week_mean_by_cat_w_phylum.csv",
...
write_delim(taxa_cat_curated, path="C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/curated_data/taxa_cat_curated.csv",
...
write_delim(tuk_wk1, path = "C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/curated_data/tuk_wk1.txt",
...
```{r}
# import methane data 
breath_wkly <- read_delim("C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab5/curated_data/breath_wkly.txt", 
                        delim = "\t", col_names = TRUE, trim_ws = TRUE, na = c("NA")) %>%
# format methane data
  rename_all(tolower) %>%
...
shapiro.test(y1$h2_mean)
ggplot(y1, aes(x=h2_mean)) +geom_histogram()

y2 <- breath_wkly %>%
  filter(supplement_consumed == "Arabino") 
shapiro.test(y2$h2_mean) 
ggplot(y2, aes(x=h2_mean)) +geom_histogram()

y3 <- breath_wkly %>%
  filter(supplement_consumed == "BRMPS+Accessible")
shapiro.test(y3$h2_mean) 
ggplot(y3, aes(x=h2_mean)) +geom_histogram()

y4 <- breath_wkly %>%
  filter(supplement_consumed == "HiMaize") 
shapiro.test(y4$h2_mean) 
ggplot(y4, aes(x=h2_mean)) +geom_histogram()

y5 <- breath_wkly %>%
  filter(supplement_consumed == "HiMaize+BRMPS") 
shapiro.test(y5$h2_mean) 
ggplot(y5, aes(x=h2_mean)) +geom_histogram()

y6 <- breath_wkly %>%
  filter(supplement_consumed == "Inulin") 
shapiro.test(y6$h2_mean) 
ggplot(y6, aes(x=h2_mean)) +geom_histogram()

y7 <- breath_wkly %>%
  filter(supplement_consumed == "LOODAT") 
shapiro.test(y7$h2_mean)
ggplot(y7, aes(x=h2_mean)) +geom_histogram()

#y8 <- breath_wkly %>%
#filter(supplement_consumed == "none") 
#shapiro.test(y8$h2_mean)
#ggplot(y8, aes(x=h2_mean)) +geom_histogram()

y9 <- breath_wkly %>%
  filter(supplement_consumed == "Psyllium") 
shapiro.test(y9$h2_mean)
ggplot(y9, aes(x=h2_mean)) +geom_histogram()

y10 <- breath_wkly %>%
  filter(supplement_consumed == "Psyllium+BRMPS") 
shapiro.test(y10$h2_mean)
ggplot(breath_wkly, aes(x=h2_mean)) +geom_histogram()

y11 <- breath_wkly %>%
  filter(supplement_consumed == "transition_HiMaize") 
shapiro.test(y11$h2_mean)
ggplot(y10, aes(x=h2_mean)) +geom_histogram()

y12 <- breath_wkly %>%
  filter(supplement_consumed == "BRMPS") 
shapiro.test(y12$h2_mean)
ggplot(y11, aes(x=h2_mean)) +geom_histogram()
...
```{r}
# conclusion 
#Here we have a telativly large p-value(p-value = 0.3001), this means our groups are not significantly different from each other.
```
...
tax_ratio <- inner_join(Fr, Br, 
  ...
  inner_join(scfa_ratio, tax_ratio,
...
plot_firmicutes_but
  save_plot(filename = "C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/figures/plot_firmicutes_but.pdf", plot = plot_firmicutes_but)
...
#This p-value is low (p-value = 0.07435), so we do have significance. But adjusted R-squared value is 0.002768, which indicates the quality of linear fit isn't good.
```

Do you draw the same conclusions if you use the butyrate ratio and Firmicutes to Bacteroidetes ratio (f_b_ratio)?
```{r}
# plot
plot_f_b_but <- tax_ratio %>%
  filter(category == "butyrogen_focused", 
         study_week == "week3") %>% 
  ggplot(aes(x = butyrate_mean,
             y = f_b_ratio)) + 
...
plot_firmicutes_but
  save_plot(filename = "C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/figures/plot_f_b_but.pdf", plot = plot_f_b_but)

# correlation test 
m63b <- tax_ratio %>%
filter(category == "butyrogen_focused", 
         study_week == "week3") %>% 
  lm(butyrate_mean ~ f_b_ratio, data = .) 
summary(m63b) #view results 

##This p-value is high (p-value = 0.3138), so we do not have significance. 
```
...
```{r}
plot_bacteroidetes_pro <- tax_ratio %>%
...
plot_firmicutes_but
  save_plot(filename = "C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/figures/plot_bacteroidetes_pro.pdf", plot = plot_bacteroidetes_pro)
...
#This p-value is low (p-value: < 2.2e-16), so we do have significance. But adjusted R-squared value is 0.05096, which indicates the quality of linear fit isn't good.
```

Do you draw the same conclusions if you use the propionate ratio and Firmicutes to Bacteroidetes ratio?
```{r}
# plot
plot_f_b_pro <- tax_ratio %>%
  filter(category == "propionate_gen", 
         study_week == "week3") %>% 
  ggplot(aes(x = propionate_mean,
             y = f_b_ratio)) + 
  ...
  ylab("Firmicutes to Bacteroidetes ratio") 
plot_f_b_pro
  save_plot(filename = "C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/figures/plot_f_b_pro.pdf", plot = plot_f_b_pro)

# correlation test 
m64b <- tax_ratio %>%
 filter(category == "propionate_gen", 
         study_week == "week3") %>% 
  lm(propionate_mean ~ f_b_ratio, data = .) 
summary(m64b) #view results 

##This p-value is low (p-value: < 2.2e-16), so we do have significance. But adjusted R-squared value is 0.04203, which indicates the quality of linear fit isn't good.
```
...
```{r}
# import 
pH_BSS_wkly <- read_delim(file = "C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab4/curated_data/ph_BSS_wkly.csv",
...
```{r}
plot_totalscfa_ace <- tax_scfa_pH %>%
  filter(study_week == "week3") %>% 
  ...
  geom_smooth(method = "lm", 
              se = FALSE) + 
  xlab("Week 3 mean total SCFAs (mmol/kg)") + 
  ylab("Week 3 mean acetate (mmol/kg)") 
plot_totalscfa_ace
  save_plot(filename = "C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/figures/plot_totalscfa_ace.pdf", plot = plot_totalscfa_ace)
...
#This p-value is low (p-value: < 2.2e-16), so we do have significance. And adjusted R-squared value is 0.9018, which indicates the quality of linear fit is good.
```

Do you draw the same conclusions if you use the total SCFAs and acetate ratio?
```{r}
plot_totalscfa_ace_ratio <- tax_scfa_pH %>%
  filter(study_week == "week3") %>% 
  ggplot(aes(x = totalscfa_mean,
             y = acetate_ratio)) + 
  geom_point() + 
  geom_smooth(method = "lm", 
              se = FALSE) + 
  xlab("Week 3 mean total SCFAs (mmol/kg)") + 
  ylab("Week 3 acetate ratio") 
  save_plot(filename = "C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/figures/plot_totalscfa_ace_ratio.pdf", plot = plot_totalscfa_ace_ratio)
plot_totalscfa_ace_ratio
# correlation test 
m65b <- tax_ratio %>%
  filter(study_week == "week3") %>% 
...
#This p-value is low (p-value: < 2.2e-16), so we do have significance. And adjusted R-squared value is 0.06402, which indicates the quality of linear fit isn't good.
```
...
plot_totalscfa_ph <- tax_scfa_pH %>%
  ...
  ylab("Week 3 mean ph") 
plot_totalscfa_ph
  save_plot(filename = "C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/figures/plot_totalscfa_ph.pdf", plot = plot_totalscfa_ph)
...
#This p-value is low (p-value: 4.186e-11), so we do have significance. And adjusted R-squared value is 0.02024, which indicates the quality of linear fit is not good.
```
...
plot_but_ph <- tax_scfa_pH %>%
  ...
  ylab("Week 3 mean ph") 
plot_but_ph
  save_plot(filename = "C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/figures/plot_but_ph.pdf", plot = plot_but_ph)
...
#This p-value is low (p-value: 0.006683), so we do have significance. And adjusted R-squared value is 0.003052, which indicates the quality of linear fit is not good.
```
...
write_delim(taxa_cat_curated, 
            path="C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/curated_data/taxa_cat_curated.txt",
            delim = "\t", quote = FALSE, col_names = TRUE)
write_delim(scfa_ratio, 
            path="C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/curated_data/scfa_ratio.txt",
            delim = "\t", quote = FALSE, col_names = TRUE)
write_delim(tax_scfa, 
            path="C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/curated_data/tax_scfa.txt",
            delim = "\t", quote = FALSE, col_names = TRUE)
write_delim(tax_scfa, 
            path="C:/Users/tina5/OneDrive/桌面/UMich_Bio201_F19/Lab6/curated_data/tax_scfa.txt",
            delim = "\t", quote = FALSE, col_names = TRUE)
